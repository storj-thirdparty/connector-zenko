...
func UploadData(project *uplink.Project, configStorj ConfigStorj, uploadPathName string, backupObjectReader *minio.Object, testObjectReader io.Reader, test_flag bool) {
